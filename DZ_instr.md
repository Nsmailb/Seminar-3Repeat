...
* создать ветку в которой будет вестись работа (git branch_ name of branch). Важно! Нельзя работать в ветке master/main так как это ошибка и в последьствии предложенные изменения не будут приняты основным разработчиком (которому вы хотите предложить свои изменения).
